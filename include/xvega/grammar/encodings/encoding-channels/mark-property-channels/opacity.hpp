...
namespace xv
{
    ...
    {
        XPROPERTY(xtl::xoptional<aggType>, Opacity, aggregate);
        XPROPERTY(xtl::xoptional<binType>, Opacity, bin);
        // XPROPERTY(xtl::xoptional<conditionType>, Opacity, condition);
        XPROPERTY(xtl::xoptional<fieldType>, Opacity, field);
        XPROPERTY(xtl::xoptional<legendType>, Opacity, legend);
        XPROPERTY(xtl::xoptional<scaleType>, Opacity, scale);
        XPROPERTY(xtl::xoptional<sortType>, Opacity, sort);
        XPROPERTY(xtl::xoptional<timeUnitType>, Opacity, timeUnit);
        XPROPERTY(xtl::xoptional<stringVecNoneType>, Opacity, title);
